...
class _GodfatherState extends State<Godfather> {
  final Uri _url=Uri.parse('https://www.youtube.com/watch?v=rUyrekdj5xs&pp=ygUXZ29kZmF0aGVyIG5ldGZsaXggaGluZGk%3D');
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image(image: AssetImage('assets/images/God Father Trailer (Hindi) _ Megastar Chiranjeevi _ Salman Khan _ Mohan Raja _ Thaman S.gif'),fit: BoxFit.cover,),
          ...
          Column(
            children: [
              ...
              Align(
                  ...
                  child: Image(image: AssetImage('assets/images/images.png'),width:300,)),
              // Align(
              //   alignment: Alignment.topLeft,
