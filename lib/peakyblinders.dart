...
class _PeakyState extends State<Peaky> {
  final Uri _url=Uri.parse('https://www.youtube.com/watch?v=PxZ5gGfPtCQ&pp=ygUWcGVha3kgYmxpbmRlcnMgdHJhaWxlcg%3D%3D');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        Image(image: NetworkImage('https://firebasestorage.googleapis.com/v0/b/netflix-5002f.appspot.com/o/ezgif.com-gif-maker.gif?alt=media&token=805321d4-d349-4a0e-b729-12187123a15b'),fit: BoxFit.cover,),
          ...
          Column(
            children: [
              ...
              Row(
                children: [
                  Image(image:NetworkImage('https://firebasestorage.googleapis.com/v0/b/netflix-5002f.appspot.com/o/Netflix-Symbol%20(1).png?alt=media&token=91d2fa09-78ee-48e7-868e-5470bedfad8f'),width: 30,),
                  SizedBox(
                    width: 10,
                  ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Padding(padding: EdgeInsets.all(10)),
                    Text('A notorious gang in 1919 Birmingham, England, is led by the fierce '
