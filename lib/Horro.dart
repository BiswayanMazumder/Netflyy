          ...
          Column(
            children: [
              ...
              Container(
                  ...
                  child: Image(image: NetworkImage('https://firebasestorage.googleapis.com/v0/b/netflix-5002f.appspot.com/o/Peaky%20Blinders%20_%20Season%205%20Trailer%20_%20Netflix.gif?alt=media&token=046a5989-0920-40f6-b5f3-c14d0daddf24'))),
                  ...
                  children: [
                    Container(
                      ...
                      child: ElevatedButton(onPressed: (){},
                          ...
                          child:Image(image: NetworkImage('https://firebasestorage.googleapis.com/v0/b/netflix-5002f.appspot.com/o/download%20(8).jpeg?alt=media&token=a733e59d-384f-4646-8498-2fc3f4a5f926'))),
                    ),
                    SizedBox(
                      width: 20,
                    ),
                    ...
                    ElevatedButton(onPressed: (){},
                        ...
                        child:Image(image: NetworkImage('https://firebasestorage.googleapis.com/v0/b/netflix-5002f.appspot.com/o/download%20(9).jpeg?alt=media&token=991cdd24-7d51-4986-9f27-24f70866cd50'),width: 150,)),
                    SizedBox(
                      width: 20,
                    ),
                    // ElevatedButton(onPressed: (){},
                  ...
                  children: [
                    Container(
                      ...
                      child: ElevatedButton(onPressed: (){},
                          ...
                          child:Image(image: NetworkImage('https://firebasestorage.googleapis.com/v0/b/netflix-5002f.appspot.com/o/possessed.webp?alt=media&token=3534807a-77e8-4d4e-95e7-46b86023b39d'))),
                    ),
                    SizedBox(
                      width: 20,
                    ),
                    ElevatedButton(onPressed: (){},
                        ...
                        child:Image(image:NetworkImage('https://firebasestorage.googleapis.com/v0/b/netflix-5002f.appspot.com/o/Queens.jpg?alt=media&token=25d8748c-20b2-46d7-b61e-030450b8f131'),fit: BoxFit.fitHeight,)),
                    SizedBox(
                      width: 20,
                    ),
                    ElevatedButton(onPressed: (){},
                        ...
                        child:Image(image: NetworkImage('https://firebasestorage.googleapis.com/v0/b/netflix-5002f.appspot.com/o/timetrap.webp?alt=media&token=2d0be1e2-6d4a-4ad1-9ea2-fbae708d6f7d'),fit: BoxFit.fitHeight,)),
                    SizedBox(
                      width: 20,
                    ),
                    ElevatedButton(onPressed: (){},
                    ...
                    ElevatedButton(onPressed: (){},
                        ...
                        child:Image(image: NetworkImage('https://firebasestorage.googleapis.com/v0/b/netflix-5002f.appspot.com/o/aka.jpg?alt=media&token=20e806e7-ce80-441c-b593-4e63855477c6'),fit: BoxFit.fitHeight,)),
                  ],
                ),
              ),
              SizedBox(
