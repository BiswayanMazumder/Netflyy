...
class _demonState extends State<demon> {
  final Uri _url=Uri.parse('https://www.youtube.com/watch?v=9DhuWapDDrw');
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image(image: AssetImage('assets/images/demon.gif'),fit: BoxFit.cover,),
          ...
          Column(
            children: [
              ...
              Image(image: NetworkImage('https://logos-world.net/wp-content/uploads/2021/12/Demon-Slayer-Logo-700x394.png')),
              // Align(
