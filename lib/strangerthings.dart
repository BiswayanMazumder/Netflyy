...
class _StrangerState extends State<Stranger> {
  final Uri _url=Uri.parse('https://www.youtube.com/watch?v=b9EkMc79ZSU&pp=ygUXc3RyYW5nZXIgdGhpbmdzIHRyYWlsZXI%3D');
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image(image: AssetImage('assets/images/Stranger Things _ Official Final Trailer _ Netflix.gif'),fit: BoxFit.cover,),
          ...
          Column(
            children: [
              ...
              Align(
                  ...
                  child: Image(image: AssetImage('assets/images/strangerlogo.jpg'),width:350,)),
              // Align(
              //   alignment: Alignment.topLeft,
